// available artists
let artists =[ "EMINEM", "KANYE", "JAYZ", "LILWAYNE", "DRAKE", "NICKIMINAJ", "TRAVISSCOTT"]
...
// FUNCTIONS: 
    ...
    function updateDisplay() {
        ...
        for (var i = 0; i < guessingArtist.length; i++) {
    ...
    function game() {
        ...
        for (var i = 0; i < artists[currentRapperIndex].length; i++) {
